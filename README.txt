# Implementação de Estrutura de Dados: Fila (Queue)
...
* `is_empty()` & `is_full()`: Verificadores de estado da fila.
* `size()`: Consulta do tamanho atual.
* `clear()`: Limpeza completa dos dados.
* **Controle de Capacidade**: Suporte a tamanho máximo definido (`max_size`), gerando erro de Overflow caso excedido.
